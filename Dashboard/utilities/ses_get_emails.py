...
if __name__ == '__main__':
    ...
    all_emails = get_all_ses_emails(client)
    verified_emails = get_verified_ses_emails(client)
    unverified_emails = get_unverified_ses_emails(client)
    print(len(all_emails))
    print(len(verified_emails))
    print(len(unverified_emails))
