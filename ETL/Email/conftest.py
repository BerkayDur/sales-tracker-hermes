...
def fixture_fake_merged_data():
    ...
    return pd.DataFrame([
        {'price_threshold': None, 'current_price': 18.99, 'previous_price': None, 'is_on_sale': False},
        {'price_threshold': None, 'current_price': 18.98, 'previous_price': 19.99, 'is_on_sale': False},
        {'price_threshold': None, 'current_price': 18.97, 'previous_price': None, 'is_on_sale': True},
        {'price_threshold': None, 'current_price': 18.96, 'previous_price': 19.98, 'is_on_sale': True},
        {'price_threshold': 16.99, 'current_price': 18.95, 'previous_price': None, 'is_on_sale': False},
        {'price_threshold': 16.98, 'current_price': 18.94, 'previous_price': 19.99, 'is_on_sale': False},
        {'price_threshold': 16.97, 'current_price': 18.93, 'previous_price': None, 'is_on_sale': True},
        {'price_threshold': 16.96, 'current_price': 18.92, 'previous_price': 19.99, 'is_on_sale': True},
        ...
        {'price_threshold': 19.97, 'current_price': 18.89, 'previous_price': 19.97, 'is_on_sale': False},
